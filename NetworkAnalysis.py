...
def plot_degree_scatter(network):
    ...
    degrees_dict = network.degree()
    degrees = np.asarray([ [key,degrees_dict[key]] for key in degrees_dict])
    degrees_cleaned = [v[1] for v in degrees if v[1] != 0]
...
def plot_in_degree_scatter(network):
    ...
    degrees_in_cleaned = [v[1] for v in degrees_in if v[1] != 0]
...
def plot_out_degree_scatter(network):
    ...
    degrees_out_cleaned = [v[1] for v in degrees_out if v[1] != 0]
...
def get_gamma_power_law(network):
    ...
    degrees_dict = network.degree()
    degrees = np.asarray([ [key,degrees_dict[key]] for key in degrees_dict])
    degrees_cleaned = np.array([v for v in degrees if v[1] != 0])
    unique, counts = np.unique(degrees_cleaned[:,1], return_counts=True)
